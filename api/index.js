...
const { 
  ...
  prestadorSchema, 
  orcamentoSchema 
} = require('../backend/schemas/validation');

// Importar sistema de upload
const { upload, handleUploadError, uploadsDir } = require('../backend/middleware/upload');
const FileManager = require('../backend/utils/fileManager');
